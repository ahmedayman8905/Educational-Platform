    ...
    public class AdminController : Controller
    {
        ...
        public IActionResult login(string Email, string password)
        {
            var instructor = db.Instructors.SingleOrDefault
                (x => x.Email == Email && x.Password == password && x.IsDelete =="foles");
        ...
        {
            ViewBag.category = db.Categories.Where(x=> x.IsDelete == "foles").ToList();
            ViewBag.students = db.Students.Where(x => x.IsDelete == "foles").ToList();
            //ViewBag.category = db.Categories.ToList();
            ViewBag.cou = db.Courses.Where(x => x.IsDelete == "foles").ToList();

            List<coursesModel> coursesModels = new List<coursesModel>();
            var f = db.Courses.Include(i => i.Instructor).Include(i => i.Cate).Where(x => x.IsDelete == "foles")
            ...
            var insts = db.Instructors.Where(x => x.IsDelete == "foles").ToList();
            return View(insts);
        ...
        {
            ViewBag.cours_search = db.Courses.Where((x) => x.Id == id && x.IsDelete == "foles")
        ...
        {
            ViewBag.AllCategories = db.Categories.Where(x => x.IsDelete == "foles").ToList();
            ViewBag.AllInstructors = db.Instructors.Where(x => x.IsDelete == "foles").ToList();
            return View();
        }
